...
#### Path prefix
> [`server.path(relativeTo)`](https://github.com/hapijs/hapi/blob/v16/API.md#serverpathrelativeto)

  - **`path.js`** - export `relativeTo`.
  - **`path/index.js`** - export `relativeTo`.

#### Globally bound context
> [`server.bind(context)`](https://github.com/hapijs/hapi/blob/v16/API.md#serverbindcontext)
...
#### Connections
> [`server.connection(options)`](https://github.com/hapijs/hapi/blob/v16/API.md#serverconnectionoptions)
>
...
> [`server.register(plugins, [options], [cb])`](https://github.com/hapijs/hapi/blob/v16/API.md#serverregisterplugins-options-callback)
...
#### Dependencies
> [`server.dependency(dependencies, [after])`](https://github.com/hapijs/hapi/blob/v16/API.md#serverdependencydependencies-after)
...
#### Provisioning caches
> [`server.cache.provision(options, [cb])`](https://github.com/hapijs/hapi/blob/v16/API.md#servercacheprovisionoptions-callback)
...
#### Server methods
> [`server.method(name, method, [options])`](https://github.com/hapijs/hapi/blob/v16/API.md#servermethodname-method-options)
...
#### Decorations
> [`server.decorate(type, property, method, [options])`](https://github.com/hapijs/hapi/blob/v16/API.md#serverdecoratetype-property-method-options)
...
#### Handler types
> [`server.handler(name, method)`](https://github.com/hapijs/hapi/blob/v16/API.md#serverhandlername-method)
...
> [`server.ext(events)`](https://github.com/hapijs/hapi/blob/v16/API.md#serverextevents)
...
#### Exposed properties
> [`server.expose(key, value)`](https://github.com/hapijs/hapi/blob/v16/API.md#serverexposekey-value)
...
> [`server.auth.scheme(name, scheme)`](https://github.com/hapijs/hapi/blob/v16/API.md#serverauthschemename-scheme)
...
> [`server.auth.strategy(name, scheme, [mode], [options])`](https://github.com/hapijs/hapi/blob/v16/API.md#serverauthstrategyname-scheme-mode-options)
...
> [`server.auth.default(options)`](https://github.com/hapijs/hapi/blob/v16/API.md#serverauthdefaultoptions)

  - **`auth/default.js`** - export `options`.
  - **`auth/default/index.js`** - export `options`.

#### Cookies
> [`server.state(name, [options])`](https://github.com/hapijs/hapi/blob/v16/API.md#serverstatename-options)
...
#### Routes
> [`server.route(options)`](https://github.com/hapijs/hapi/blob/v16/API.md#serverrouteoptions)
